...
export default class FaceFlapsDrawer {
    ...
    public draw(source: Source, dest: HTMLCanvasElement, face: Face) {
        ...
        this.drawFlaps(ctx, source, face);
    ...
    private drawFlaps(
        ...
        this.drawHeadMask(ctx, source, head);
        this.drawMouthFlap(ctx, source, mouth, eyes.angle);
        this.drawEyesFlap(ctx, source, eyes);
    }

    private drawEyesFlap(
        ctx: CanvasRenderingContext2D,
        source: Source,
        eyes: Eyes
    ) {
